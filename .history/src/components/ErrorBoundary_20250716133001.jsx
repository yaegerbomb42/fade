...
class ErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    ...
    // TODO: Integrate with external error monitoring service here
  }
        ...
        <div className="min-h-screen flex items-center justify-center bg-neutral-50 p-4">
          <div className="text-center max-w-md w-full">
            ...
            <div className="flex flex-col gap-2 text-center mb-4">
              ...
              {this.state.error && (
                <details className="text-xs text-text-secondary mt-2 whitespace-pre-wrap text-left max-w-full mx-auto">
            ...
            <div className="flex justify-center items-center gap-4">
              <button
                ...
                className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-4 rounded transition-colors duration-200 shadow-sm"
              >
                Try Again
              </button>
              <button
