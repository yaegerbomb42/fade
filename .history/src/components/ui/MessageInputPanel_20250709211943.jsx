...
const MessageInputPanel = ({ onSendMessage, activeChannel, isTyping, onTypingChange }) => {
  ...
  if (showNicknameInput) {
    return (
      <div className="fixed bottom-24 left-1/2 transform -translate-x-1/2 z-interface w-full max-w-md px-4">
  ...
  return (
    <div className="fixed bottom-24 left-1/2 transform -translate-x-1/2 z-interface w-full max-w-2xl px-4">
      {/* Emoji Hotbar */}
      {showEmojiBar && (
        <div className="mb-2">
