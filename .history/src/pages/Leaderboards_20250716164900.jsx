    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900">
      <div className="container mx-auto px-6 py-10">
        ...
        <div className="text-center mb-10 relative">
          <button
            onClick={() => navigate('/')}
            className="absolute left-0 top-0 glass-panel p-4 hover:bg-white/20 text-white transition-all duration-200 backdrop-blur-md rounded-xl"
          >
            <Icon name="ArrowLeft" className="w-6 h-6" />
          </button>
          
          <div className="flex items-center justify-center mb-8">
            <FadeLogo className="w-24 h-24" />
          </div>
          ...
          <p className="text-blue-200 text-xl">Top performers in the Fade community</p>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <div className="backdrop-blur-md rounded-3xl p-8 bg-gradient-to-br from-blue-500/30 to-blue-600/20 border border-blue-400/50 shadow-lg">
                <div className="text-center mb-8">
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center mx-auto mb-4">
                    <Icon name="MessageSquare" className="w-7 h-7 text-white" />
                  </div>
                  <h2 className="text-3xl font-bold text-white mb-2">Top Messagers</h2>
                  <p className="text-blue-200 text-base">Most active chatters</p>
                </div>
              ...
              {/* Likes Leaderboard */}
              <div className="backdrop-blur-md rounded-3xl p-8 bg-gradient-to-br from-pink-500/30 to-red-600/20 border border-pink-400/50 shadow-lg">
                <div className="text-center mb-8">
                  <div className="w-14 h-14 bg-gradient-to-br from-pink-400 to-red-600 rounded-xl flex items-center justify-center mx-auto mb-4">
                    <Icon name="Heart" className="w-7 h-7 text-white" />
                  </div>
                  <h2 className="text-3xl font-bold text-white mb-2">Most Liked</h2>
                  <p className="text-pink-200 text-base">Community favorites</p>
                </div>
              ...
              {/* XP Leaderboard */}
              <div className="backdrop-blur-md rounded-3xl p-8 bg-gradient-to-br from-purple-500/30 to-purple-600/20 border border-purple-400/50 shadow-lg">
                <div className="text-center mb-8">
                  <div className="w-14 h-14 bg-gradient-to-br from-purple-400 to-purple-600 rounded-xl flex items-center justify-center mx-auto mb-4">
                    <Icon name="Zap" className="w-7 h-7 text-white" />
                  </div>
                  <h2 className="text-3xl font-bold text-white mb-2">Top Experience</h2>
                  <p className="text-purple-200 text-base">Most experienced users</p>
                </div>
        ...
        <div className="text-center mt-16">
          <button
            onClick={() => navigate('/')}
            className="glass-panel px-10 py-5 hover:bg-white/20 text-white font-semibold transition-all duration-300 backdrop-blur-md rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105"
          >
            <Icon name="MessageSquare" className="w-6 h-6 inline mr-3" />
            Back to Chat
          </button>
        </div>

        {/* Made by Yaeger Footer */}
        <div className="text-center mt-10 mb-6">
          <p className="text-white/60 text-base">
            Made by <span className="text-white/80 font-semibold">Yaeger</span>
          </p>
        </div>
      </div>
    </div>
