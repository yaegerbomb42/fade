  ...
  useEffect(() => {
    ...
    const checkAndStyleAd = () => {
      ...
      if (adContainer && adContainer.innerHTML) {
        // Apply square dimensions to the ad
        adContainer.style.width = '200px';
        adContainer.style.height = '200px';
        adContainer.style.maxWidth = '200px';
        adContainer.style.maxHeight = '200px';
        ...
        // Style any child elements to fit within the square
...
const MainChatInterface = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      {/* Message Display Area - adjusted for compact ad banner */}
      <div className="fixed inset-0 pointer-events-none z-messages pt-28 pb-20">
        {messages
      ...
      {/* Adsterra Native Banner - compact size at bottom */}
      <div className="fixed bottom-0 left-0 right-0 z-interface bg-background/95 backdrop-blur-md border-t border-glass-border/50" style={{ height: '60px' }}>
        <div className="flex items-center justify-center h-full px-4">
          <AdsterraBanner />
        </div>
      </div>

      {/* Privacy Policy Link - moved above ad banner */}
      <div className="fixed bottom-16 right-4 z-interface">
        <Link
          to="/privacy"
