...
const MainChatInterface = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-interface bg-background/90 backdrop-blur-md border-t border-glass-border">
        <AdsterraBanner />
      </div>

      {/* Privacy Policy Link - moved above ad banner */}
      <div className="fixed bottom-24 right-4 z-interface">
        <Link
          to="/privacy"
