          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex flex-col space-y-1">
              <button
                ...
                title="Leaderboards"
              >
                <Icon name="bar-chart-3" className="w-4 h-4 text-text-secondary group-hover:text-primary transition-colors" />
              </button>
              <button
                onClick={() => {
                  setProfileUser({ ...user, username: user.username });
            ...
            {(authUIMinimized && !guestModeConfirmed) ? (
              ...
              <div className="flex items-center space-x-1">
                <button
                  ...
                  title="Leaderboards"
                >
                  <Icon name="bar-chart-3" className="w-3 h-3 text-text-secondary group-hover:text-primary transition-colors" />
                </button>
                <button
                  onClick={() => setAuthUIMinimized(false)}
                  className="glass-button p-2 hover:bg-glass-surface/40 transition-all duration-300 group"
                  title="Sign up"
                >
                  <Icon name="plus" className="w-3 h-3 text-text-secondary group-hover:text-primary transition-colors" />
                </button>
              </div>
            ) : (
              // Expanded Auth UI
              <div className="space-y-2">
                <div className="glass-panel p-3 max-w-xs">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <Icon name="bar-chart-3" className="w-3 h-3 inline mr-1" />
                      Leaderboards
                    </button>
