...
const MainChatInterface = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      {/* Message Display Area - adjusted padding for ad banner */}
      <div className="fixed inset-0 pointer-events-none z-messages pt-28 pb-24">
        {messages
      ...
      {/* Adsterra Native Banner - positioned at bottom */}
      <div className="fixed bottom-0 left-0 right-0 z-interface bg-background/80 backdrop-blur-sm">
        <script 
          async="async" 
          data-cfasync="false" 
          src="//pl27125133.profitableratecpm.com/58d94318819023c51d2375249b2d6604/invoke.js"
        ></script>
        <div id="container-58d94318819023c51d2375249b2d6604"></div>
      </div>

      {/* Privacy Policy Link - moved above ad banner */}
      <div className="fixed bottom-20 right-4 z-interface">
        <Link
          to="/privacy"
