...
const MainChatInterface = () => {
  ...
  const [showShareNotification, setShowShareNotificationState] = useState(false);
  
  const showShareNotification = () => {
    setShowShareNotificationState(true);
    setTimeout(() => setShowShareNotificationState(false), 2000);
  };
