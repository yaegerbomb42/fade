...
const AdsterraBanner = () => {
  useEffect(() => {
    ...
    // Apply custom styling after ad loads - with strict containment
    const checkAndStyleAd = () => {
      ...
      if (adContainer && adContainer.innerHTML) {
        ...
        adContainer.style.overflow = 'hidden'; // Strict containment
        ...
        adElements.forEach(el => {
          ...
          el.style.position = 'relative'; // Prevent absolute/fixed positioning
