    ...
    >
      <div className={`vibey-card bg-gradient-to-br ${bubbleGradient} border border-glass-border/30 hover:border-glass-highlight/50 transition-all duration-300 group relative overflow-hidden`}>
        ...
        <div className="relative z-10 p-3">
          ...
          {/* Message Content - proper wrapping for longer text */}
          <div className="text-sm text-text-primary leading-snug mb-3 break-words whitespace-pre-wrap" style={{
            wordBreak: 'break-word',
            overflowWrap: 'break-word',
            maxWidth: '320px' // Ensure consistent width for 40-char lines
          }}>
            {message.text}
          </div>
