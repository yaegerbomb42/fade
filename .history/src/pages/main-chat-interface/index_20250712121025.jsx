      ...
      <div className="fixed top-4 right-4 z-50 flex items-center space-x-2">
        {isSignedIn ? (
          <div className="flex items-center space-x-2">
            <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg px-3 py-2 flex items-center space-x-2">
              <span className="text-white text-sm font-medium">@{user.username}</span>
              <span className="text-xs bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-2 py-1 rounded font-bold">
                L{user.level || 1}
              </span>
            </div>
            <button
