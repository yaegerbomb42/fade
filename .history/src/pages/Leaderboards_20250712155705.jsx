...
const Leaderboards = ({ database }) => {
  ...
  useEffect(() => {
    // Always show placeholder data immediately, then try to load real data
    ...
    // Load data after a short delay to ensure placeholder is shown first
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mt-8 mb-4">
          <p className="text-white/50 text-sm">
            Made by <span className="text-white/70 font-medium">Yaeger</span>
          </p>
        </div>
      </div>
    </div>
